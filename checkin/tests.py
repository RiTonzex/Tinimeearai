...
class CheckinAppTests(TestCase):
    ...
    def test_admin_dashboard_and_moderation(self):
        ...
        # Test user pagination in admin dashboard (9 per page)
        for i in range(15):
        ...
        self.assertEqual(len(resp_page1.context['users_list']), 9)
        ...
        self.assertTrue(len(resp_page2.context['users_list']) >= 6)
